...
除了以上我所使用过的时间自动记录软件之外，我还知道一个Rize。<Footnote idName={2}>我知道Rize是因为看了来自youtube博主Ali Abdaal的一期视频。</Footnote>
...
另外，这些软件也可以根据浏览网页的不同计算生产效率值，比如浏览netflix网站是低产的，而

RescueTime的致命问题就在于对于网页的 不够细化。你只能规定bilibili.com是低效的，但是你不能规定浏览bilibili中的法考视频的页面是高产。
